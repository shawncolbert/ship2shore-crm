...
const HEADER_IDEAS = [
  ...
  '16 YEARS ON THE DOCKS', 'SAME-DAY PORT ESCORT', 'YOUR CAR, DELIVERED SAFE',
  'NO BROKER FEES', 'DIRECT PORT ESCORT SERVICE', 'PORT TO YOUR DOOR',
  'ANOTHER SUCCESSFUL PICKUP', 'CUSTOMS CLEARED — ON THE MOVE', 'PORT ESCORT — DONE RIGHT',
  'KEI TRUCK PICKUP COMPLETE', 'KNOW YOUR PORT ESCORT', 'KEEPING IT MOVING SINCE DAY ONE',
  'KEI TRUCKS, CLASSICS & MORE',
]
const FOOTER_IDEAS = [
  ...
  'Your Trusted Port Escort', 'Escorts • Transport • On Time',
